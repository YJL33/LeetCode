        ...
        while len(q) != 0:
            ...
            if c not in visited:
                if c == target:
                    return steps
                visited[c] = steps
                nextMoves = self.generator(c, visited)
                for n in nextMoves:
                    if n not in dd and steps+1 < 73:
                        q.append((n, steps+1))
        return -1
