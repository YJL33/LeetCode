...
together with starting city src and the destination dst, your task is to find the cheapest price from src to dst with up to k stops. If there is no such route, output -1.
...
print Solution().findCheapestPrice(3, [[0,1,2],[1,2,1],[2,0,10]], 1, 2, 1), "should be 1"
print Solution().findCheapestPrice(4, [[0,1,1],[0,2,5],[1,2,1],[2,3,1]], 0, 3, 1), "should be 6"
